...
import { ShieldCheckIcon, MapPinIcon, CurrencyDollarIcon } from '@heroicons/react/24/outline';

const benefits = [
  {
    title: 'Terverifikasi & Terpercaya',
    description: 'Semua bengkel sudah dicek dan diverifikasi langsung oleh tim kami.',
    icon: <ShieldCheckIcon className="w-10 h-10 text-blue-600" />,
  },
  {
    title: 'Terdekat & Siap Bantu',
    description: 'Kami bantu carikan bengkel paling dekat dengan lokasi kamu saat ini.',
...
const WhyServisGoSection: React.FC = () => {
  return (
    <section className="bg-gray-50 py-16 px-6 md:px-16 text-center">
      <h2 className="text-3xl font-bold text-gray-800 mb-12">Kenapa Harus ServisGo?</h2>
